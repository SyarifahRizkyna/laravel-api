...
Route::prefix('auth')->group(function () {
    // Registrasi kasir
    Route::post('/register/cashier', [AuthController::class, 'registerCashier'])->name('api.auth.register.cashier');

    // Registrasi pelanggan
    Route::post('/register/customer', [AuthController::class, 'registerCustomer'])->name('api.auth.register.customer');

    // Login kasir
    Route::post('/login/cashier', [AuthController::class, 'loginCashier'])->name('api.auth.login.cashier');
